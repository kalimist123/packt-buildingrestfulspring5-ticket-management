package com.packtpub.restapp.ticketmanagement.aop;

import javax.servlet.http.HttpServletRequest;
import javax.xml.bind.DatatypeConverter;

import com.packtpub.restapp.ticketmanagement.service.SecurityServiceImpl;
...
public class UserTokenRequiredAspect {
    ...
    public void tokenRequiredWithAnnotation(UserTokenRequired
                                                    userTokenRequired) throws Throwable{
